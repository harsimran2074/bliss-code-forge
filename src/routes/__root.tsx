...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Maison — Considered home goods" },
      { name: "description", content: "A quiet collection of home goods, made slowly and shipped worldwide." },
      { property: "og:title", content: "Maison — Considered home goods" },
